...
export const playlists: Playlist[] = [
  {
    id: "1",
    title: "Seapig Tickets",
    color: colors.teal,
    cover:
      "https://dodo.ac/np/images/a/a9/Sea_Pig_NH_Icon.png",
    artists: ["Anon#1", "Anon#2"],
  },
  {
    id: "2",
    title: "Summer Pop",
    color: colors.green,
    cover:
      "/seapig_summer_pop.jpg",
    artists: ["Chappell Roan", "Sabrina Carpenter"],
  },
  {
    id: "3",
    title: "Trap Vibes",
  ...
  },
  {
    ...
    color: colors.gray,
    cover:
      "https://ih1.redbubble.net/image.1019158229.7152/st,small,507x507-pad,600x600,f8f8f8.jpg",
